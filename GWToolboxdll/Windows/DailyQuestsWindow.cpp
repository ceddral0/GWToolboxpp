...
void DailyQuests::Draw(IDirect3DDevice9*)
{
    ...
    float offset = 0.0f;
    const float short_text_width = 120.0f * ImGui::GetStyle().FontScaleMain;
    const float long_text_width = text_width * ImGui::GetStyle().FontScaleMain;
    const float zm_width = 170.0f * ImGui::GetStyle().FontScaleMain;
    const float zb_width = 185.0f * ImGui::GetStyle().FontScaleMain;
    const float zc_width = 135.0f * ImGui::GetStyle().FontScaleMain;
    const float zv_width = 200.0f * ImGui::GetStyle().FontScaleMain;
    const float ws_width = 180.0f * ImGui::GetStyle().FontScaleMain;
    const float nicholas_width = 180.0f * ImGui::GetStyle().FontScaleMain;
    const float wbe_width = 145.0f * ImGui::GetStyle().FontScaleMain;
    const float vanguard_width = 180.0f * ImGui::GetStyle().FontScaleMain;
    const float sandford_width = 200.0f * ImGui::GetStyle().FontScaleMain;
    ...
    ImGui::NewLine();
    ImGui::Separator();
    ImGui::BeginChild("dailies_scroll", ImVec2(0, -1 * (40.0f * ImGui::GetStyle().FontScaleMain) - ImGui::GetStyle().ItemInnerSpacing.y));
