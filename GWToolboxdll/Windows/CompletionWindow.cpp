...
bool Mission::Draw(IDirect3DDevice9*)
{
    ...
    if (is_completed && bonus && show_as_list) {
        ...
        ImVec2 icon_size_scaled = {icon_size.x * ImGui::GetStyle().FontScaleMain, icon_size.y * ImGui::GetStyle().FontScaleMain};
        if (show_as_list) {
...
void CompletionWindow::Draw(IDirect3DDevice9* device)
{
    ...
    const float gscale = ImGui::GetStyle().FontScaleMain;
    ...
    int missions_per_row = static_cast<int>(std::floor(ImGui::GetContentRegionAvail().x / (ImGui::GetStyle().FontScaleMain * single_item_width + ImGui::GetStyle().ItemSpacing.x)));
    const float checkbox_offset = ImGui::GetContentRegionAvail().x - 200.f * ImGui::GetStyle().FontScaleMain;
...
void CompletionWindow::DrawHallOfMonuments(IDirect3DDevice9* device)
{
    ...
    const int missions_per_row = static_cast<int>(std::floor(ImGui::GetContentRegionAvail().x / (ImGui::GetStyle().FontScaleMain * single_item_width + ImGui::GetStyle().ItemSpacing.x)));
    const float checkbox_offset = ImGui::GetContentRegionAvail().x - 200.f * ImGui::GetStyle().FontScaleMain;
