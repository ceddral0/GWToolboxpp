...
void FriendListWindow::Draw(IDirect3DDevice9*)
{
    ...
    const auto window_size = ImVec2(540.0f * ImGui::GetStyle().FontScaleMain, 512.0f * ImGui::GetStyle().FontScaleMain);
    const float cols[3] = {180.0f * ImGui::GetStyle().FontScaleMain, 360.0f * ImGui::GetStyle().FontScaleMain, 540.0f * ImGui::GetStyle().FontScaleMain};
...
void FriendListWindow::DrawSettingsInternal()
{
    ...
    const float dropdown_width = 160.0f * ImGui::GetStyle().FontScaleMain;
    ImGui::Text("Show as");
    ImGui::SameLine();
