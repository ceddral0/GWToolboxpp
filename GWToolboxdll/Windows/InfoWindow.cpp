...
namespace {
    ...
    bool EncInfoField(const char* label, const wchar_t* enc_string)
    {
        ...
        return ImGui::InputTextEx(label, nullptr, info_string.data(), info_string.size(), ImVec2(-160.f * ImGui::GetStyle().FontScaleMain, 0), ImGuiInputTextFlags_ReadOnly);
    }
    ...
    bool InfoField(const char* label, const char* fmt, ...)
    {
        ...
        info_string[127] = 0;
        va_end(vl);
        return ImGui::InputTextEx(label, nullptr, info_string, _countof(info_string), ImVec2(-160.f * ImGui::GetStyle().FontScaleMain, 0), ImGuiInputTextFlags_ReadOnly);
    }
